		...
		"xml_nested" : function () {
			return {
				...
				parse	: function(data, tree, opts, callback) { 
					...
					var result = $((new XMLSerializer()).serializeToString(processor.transformToDocument(data)).replace(' <?php xml version="1.0"?>',''));
					// Opera bug
