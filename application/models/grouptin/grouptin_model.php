...
------------------------------------------------*/
class grouptin_model extends CI_Model {
	...
	function add($data) {
        ...
        $this->db->set('type', "1");
        $this->db->set('icon','images/news/icon-thiet-ke-web.png');
        $this->db->set('images', $data['image']);
...
//        exit;
	...
	function get_grouptin_where($where = null, $order = null, $limit = null) {
