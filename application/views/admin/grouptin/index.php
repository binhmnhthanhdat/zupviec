<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=base_url();?>admin/grouptin-ad/home">
                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                                ...
                                <td class="left"><a href="#">Icon</a></td>
                                <td class="left"><a href="#">Hình ảnh</a></td>
                                 <td class="left"><a href="#">Meta keywod</a></td>
                                <td class="left"><a href="#">Meta Description</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left" style="width: 15%;"><?=$user['name'];?></td>
                                 <td class="left" style="width: 10%;"><?=$user['title'];?></td>
                                <td class="left" style="width: 10%;"><img src="<? echo base_url(); echo $user['icon'];?>" alt="tin tuc"  width="20" height="20" /></td>
                                 <td class="left" style="width: 20%;"><img src="<? echo base_url(); echo $user['images'];?>" alt="tin tuc"  width="200" height="100" /></td>
                                 
                               
                               <td class="left" style="width: 15%;"><? echo $user['metakeyword'];?></td>
                             
                              <td class="left" style="width: 15%;"><?=$user['metadescription'];?></td>
