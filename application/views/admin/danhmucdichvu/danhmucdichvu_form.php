        ...
        <div class="box">
        	<div class="heading">
                ...
                <div class="buttons">
                    ...
                    <a href="javascript:void(0);" onclick="location.href='<?=base_url();?>admin/danhmucdichvu-ad/home';" class="button">Cancel</a>
                </div>
            </div><!--End heading-->
            <div class="content">
                                ...
                                <tr>
                                  <td width="169" align="left"><label>Hinh anh:</label></td>
                                    <td width="922">
                                        ...
                                        <img src="<?=base_url();?><?=@@$article->images;?>" width="200" height="200">
                                        <?php endif;?>   
                                    </td>
                                </tr>
                                <tr>
