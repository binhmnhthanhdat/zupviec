                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                                ...
                                <td class="left"><a href="#">Metakeywrord</a></td>
                                <td class="left"><a href="#">Metadescription</a></td>
                                <td class="left"><a href="#">Content</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="left" style="width: 10%;"><?=$user['title'];?></td>
                                 <td class="left" style="width: 10%;"><?=$user['metakeyword'];?></td>
                                 <td class="left" style="width: 10%;"><?=$user['metadescription'];?></td>
                               
                               <td class="left" style="width: 45%;"><? echo mb_substr($user['content'], 0,200, 'UTF-8');;?></td>
