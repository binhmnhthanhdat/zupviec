<div id="content">
        ...
        <div class="box">
            ...
            <div class="content">
            	<form id="form_list" method="post" action="<?=base_url();?>admin/listhoidap-ad/home">
                	...
                	<table class="list">
                    	<thead>
                        	<tr>
								...
								<td class="left"><a href="#">Danh muc cha</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
							    ...
							    <td class="right">
                                    ...
                                    {
                                        	$sql="select * from group_hoidap where id=\"".$user['parent']."\"";	
                                             $namemenu= $this->db->query($sql);
											 if($namemenu->num_rows()>0)
											 {
