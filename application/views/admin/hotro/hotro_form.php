        ...
        <div class="box">
        	<div class="heading">
                ...
                <div class="buttons">
                    ...
                    <a href="javascript:void(0);" onclick="location.href='<?=base_url();?>admin/hotro';" class="button">Cancel</a>
                </div>
            </div><!--End heading-->
            <div class="content">
						...
						<tbody>
                           	  <tr>
                                  <td width="169" align="left"><label>Name:</label></td>
                                    <td width="922">
                                    	<?php if(@$article->name !='') :?>
                                        <input name="name" type="text" id="title" value="<?php echo @$article->name;?>" size="100" />
                                        <?php else : ?>
                                        <input name="name" type="text" id="title" value="<?php echo set_value('name');?>" size="100" />
                                        <?php endif;?>
                                    	<?=form_error('name');?>
                                	</td>
                                </tr>
                                ...
                                <tr>
                                  <td width="169" align="left"><label>Tên yahoo ( không chứa @yahoo.com ) :</label></td>
                                    <td width="922">
                                    	<?php if(@$article->yahoo !='') :?>
                                        <input name="yahoo" type="text" id="yahoo" value="<?php echo @$article->yahoo;?>" size="100" />                                     <?php else : ?>
                                        <input name="yahoo" type="text" id="yahoo" value="<?php echo set_value('yahoo');?>" size="100" /> 
                                        <?php endif;?>
                                    	<?=form_error('yahoo');?>
                                	</td>
                                </tr>
