                	...
                	<table class="list">
                    	<thead>
                        	<tr>
                                ...
                                <td class="left"><a href="#">Tên Hiển thị</a></td>
                                <td class="left"><a href="#">Địa chỉ yahoo(không chứa @yahoo.com)</a></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="text-align:center"  style="width: 10%;"><input type="checkbox" name="selected[]" value="<?=$user['id'];?>" /></td>
                                <td class="left" style="width: 40%;"><?=$user['name'];?></td>
                                
                                
                               <td class="left"  style="width: 50%;"><? echo $user['yahoo'];?></td>
